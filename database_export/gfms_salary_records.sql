...
CREATE TABLE `salary_records` (
  ...
  `sg_step` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `monthly_basic` decimal(12,2) NOT NULL DEFAULT '0.00',
  `months_served` tinyint unsigned NOT NULL DEFAULT '0',
  `gsis_ps` decimal(12,2) NOT NULL DEFAULT '0.00',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `salary_records_employee_id_unique` (`employee_id`)
